...
var (
	funtables_ = map[string]*innerFunc{
		...
		"str_has_prefix": {nil, 0, "", "", false, hasPrefixFunc, "str_has_prefix", 2},
		"str_has_suffix": {nil, 0, "", "", false, hasSuffixFunc, "str_has_suffix", 2},
...
var newFunc = FuncDefine(func(ctx *Context) any {
...
var orrFunc = FuncDefine2(func(ctx *Context, a any, b any) any {
	if a != nil {
		return a
	}
	return b
...
var powFunc = FuncDefine2(func(ctx *Context, x, y float64) float64 { return math.Pow(x, y) })
...
// FuncDefine1 定义单参数函数（自动注入 Context 作为第一个参数）
func FuncDefine1[A1 any, R any](f func(ctx *Context, a A1) R) ScriptFunc {
...
// Deprecated: 使用 FuncDefine1 代替（现在已自动包含 Context）
func FuncDefine1WithCtx[A1 any, R any](f func(ctx *Context, a A1) R) ScriptFunc {
	return FuncDefine1(f)
}

// FuncDefine 定义无参数函数（自动注入 Context 作为第一个参数）
func FuncDefine[R any](f func(ctx *Context) R) ScriptFunc {
	return func(ctx *Context, args ...Val) any {
		return f(ctx)
	}
}

// Deprecated: 使用 FuncDefine 代替（现在已自动包含 Context）
func FuncDefineWithCtx[R any](f func(ctx *Context) R) ScriptFunc {
	return FuncDefine(f)
}

// FuncDefine2 定义双参数函数（自动注入 Context 作为第一个参数）
func FuncDefine2[A1 any, A2 any, R any](f func(ctx *Context, a A1, b A2) R) ScriptFunc {
	return func(ctx *Context, args ...Val) any {
		a, _ := args[0].Val(ctx).(A1)
...
// Deprecated: 使用 FuncDefine2 代替（现在已自动包含 Context）
func FuncDefine2WithCtx[A1 any, A2 any, R any](f func(ctx *Context, a A1, b A2) R) ScriptFunc {
	return FuncDefine2(f)
}

// FuncDefine3 定义三参数函数（自动注入 Context 作为第一个参数）
func FuncDefine3[A1 any, A2 any, A3 any, R any](f func(ctx *Context, a A1, b A2, c A3) R) ScriptFunc {
	return func(ctx *Context, args ...Val) any {
		a, _ := args[0].Val(ctx).(A1)
		b, _ := args[1].Val(ctx).(A2)
...
// Deprecated: 使用 FuncDefine3 代替（现在已自动包含 Context）
func FuncDefine3WithCtx[A1 any, A2 any, A3 any, R any](f func(ctx *Context, a A1, b A2, c A3) R) ScriptFunc {
	return FuncDefine3(f)
}

// FuncDefine4 定义四参数函数（自动注入 Context 作为第一个参数）
func FuncDefine4[A1 any, A2 any, A3 any, A4 any, R any](f func(ctx *Context, a A1, b A2, c A3, d A4) R) ScriptFunc {
	return func(ctx *Context, args ...Val) any {
		a, _ := args[0].Val(ctx).(A1)
		b, _ := args[1].Val(ctx).(A2)
		c, _ := args[2].Val(ctx).(A3)
...
// Deprecated: 使用 FuncDefine4 代替（现在已自动包含 Context）
func FuncDefine4WithCtx[A1 any, A2 any, A3 any, A4 any, R any](f func(ctx *Context, a A1, b A2, c A3, d A4) R) ScriptFunc {
	return FuncDefine4(f)
}

// FuncDefine5 定义五参数函数（自动注入 Context 作为第一个参数）
func FuncDefine5[A1 any, A2 any, A3 any, A4 any, A5 any, R any](f func(ctx *Context, a A1, b A2, c A3, d A4, e A5) R) ScriptFunc {
	return func(ctx *Context, args ...Val) any {
		a, _ := args[0].Val(ctx).(A1)
		b, _ := args[1].Val(ctx).(A2)
		c, _ := args[2].Val(ctx).(A3)
...
// Deprecated: 使用 FuncDefine5 代替（现在已自动包含 Context）
func FuncDefine5WithCtx[A1 any, A2 any, A3 any, A4 any, A5 any, R any](f func(ctx *Context, a A1, b A2, c A3, d A4, e A5) R) ScriptFunc {
	return FuncDefine5(f)
}

// FuncDefine1WithDef 定义带默认值的单参数函数（自动注入 Context 作为第一个参数）
func FuncDefine1WithDef[A any, R any](f func(ctx *Context, a A) R, def R) ScriptFunc {
	return func(ctx *Context, args ...Val) any {
		if len(args) != 1 {
			return def
		}
...
// FuncDefineN 定义可变参数函数（自动注入 Context 作为第一个参数）
func FuncDefineN[T any, R any](f func(ctx *Context, a ...T) R) ScriptFunc {
	return func(ctx *Context, args ...Val) any {
...
var deleteFunc = FuncDefine2(func(ctx *Context, m map[string]any, b string) any {
	delete(m, b)
	return nil
})

var add2Func = FuncDefine2(func(ctx *Context, a, b any) any {
	return add2(a, b)
})
...
var subFunc = FuncDefine2(func(ctx *Context, a, b float64) any {
	return a - b
})
var divFunc = FuncDefine2(func(ctx *Context, a, b float64) any {
	return a / b
})
var mulFunc = FuncDefine2(func(ctx *Context, a, b float64) any {
	return a * b
})
var modFunc = FuncDefine2(func(ctx *Context, a, b float64) any {
	return float64(int(a) % int(b))
})
var hasPrefixFunc = FuncDefine2(func(ctx *Context, a, b string) any {
	return strings.HasPrefix(a, b)
})

var hasSuffixFunc = FuncDefine2(func(ctx *Context, a, b string) any {
	return strings.HasSuffix(a, b)
})

var trimFunc = FuncDefine1(func(ctx *Context, s string) string { return strings.TrimSpace(s) })
var splitFunc = FuncDefine3(func(ctx *Context, a, b string, n float64) any {
...
var toUpperFunc = FuncDefine1(func(ctx *Context, s string) string { return strings.ToUpper(s) })

var toLowerFunc = FuncDefine1(func(ctx *Context, s string) string { return strings.ToLower(s) })

var jsonEncode = FuncDefine1(func(ctx *Context, a any) any {
...
var jsonDecode = FuncDefine1(func(ctx *Context, a any) (res any) {
	switch a := a.(type) {
	case string:
...
var timeNow = FuncDefine(func(ctx *Context) time.Time { return time.Now() })

var notFunc = FuncDefine1(func(ctx *Context, a any) bool {
	return !BoolCond(a)
})

var notEqFunc = FuncDefine2(func(ctx *Context, a any, b any) bool {
	return a != b
})
var notEqSFunc = FuncDefine2(func(ctx *Context, a any, b any) bool {
	if a != b {
		return true
	}
...
var largeFunc = FuncDefine2(func(ctx *Context, a any, b any) bool {
...
var largeOrEqual = FuncDefine2(func(ctx *Context, a any, b any) bool {
	return compare(a, b) >= 0
})
var lessFunc = FuncDefine2(func(ctx *Context, a any, b any) bool {
	return compare(a, b) < 0
})
var lessOrEqual = FuncDefine2(func(ctx *Context, a any, b any) bool {
	return compare(a, b) <= 0
})
...
var makeArrFunc = FuncDefine1(func(ctx *Context, a float64) any {
...
var arrSliceFunc = FuncDefine3(func(ctx *Context, arr []any, start, end float64) any {
	endi := int(end)
	starti := int(start)
	if len(arr) < endi {
		endi = len(arr)
...
var base64Encode = FuncDefine1WithDef(func(ctx *Context, a any) string {
	switch v := a.(type) {
	case string:
...
var base64Decode = FuncDefine1WithDef(func(ctx *Context, a string) any {
...
var bytesFuncs = FuncDefine1(func(ctx *Context, v any) []byte { return BytesOf(v) })
...
var hexEncodeFunc = FuncDefine1WithDef(func(ctx *Context, a any) string {
	return hex.EncodeToString(BytesOf(a))
}, "")

var hexDecodeFunc = FuncDefine1WithDef(func(ctx *Context, a any) any {
...
var hmacSha266Func = FuncDefine2(func(ctx *Context, a any, b any) []byte {
	h := hmac.New(sha256.New, BytesOf(b))
	h.Write(BytesOf(a))
	return h.Sum(nil)
})
var lenFunc = FuncDefine1(func(ctx *Context, a any) float64 {
	switch a := a.(type) {
	case string:
...
var returnFunc = FuncDefineN(func(ctx *Context, a ...any) any {
	return &Return{
		Var: a,
	}
})
...
var funcTimeParse = FuncDefine2(func(ctx *Context, layout string, val string) any {
...
var funcCatch = FuncDefine1(func(ctx *Context, a any) any {
...
var funcUnwrap = FuncDefine1WithCtx(func(ctx *Context, a any) any {
	res, ok := a.(*Result)
	if ok {
		if res.Err != nil {
			return newErrorWithCtx(res.Err, ctx)
		}
		return res.Data
	}
	return a
...
var funcBool = FuncDefine1(func(ctx *Context, a any) any {
	return BoolOf(a)
})
...
var funcSleep = FuncDefine1(func(ctx *Context, a float64) any {
	time.Sleep(time.Duration(a) * time.Millisecond)
	return nil
})

var funcRange = FuncDefine1(func(ctx *Context, a float64) any {
	return make([]any, int(a))
})
...
var funcRand = FuncDefine1(func(ctx *Context, a float64) []byte {
	_randLock.Lock()
...
var funcLog10 = FuncDefine1(func(ctx *Context, a float64) float64 {
	return math.Log10(a)
})

var funcSqrt = FuncDefine1(func(ctx *Context, a float64) float64 {
	return math.Sqrt(a)
})
...
func init() {
	DefaultEnv.RegisterFunc("duration", func(ctx *Context, args ...Val) any {
		...
		if err != nil {
			return newErrorfWithCtx(ctx, "parse duration: %v", err)
		}
		return s
	}, 1, WithArgsString("(3s)"))
}
